'use client'
import { Box, Button, Center, Heading, Icon, Image, Stack, Text } from '@chakra-ui/react'
    ...
    <Box px={8} py={32} mx="auto">
        <Box w={{ base: "full", md: 11 / 12, xl: 9 / 12,}} mx="auto" textAlign={{ base: "center", md: "center", }} >
            ...
            <Stack direction={{ base: "column", sm: "row", }} mb={{ base: 4, md: 8, }} spacing={2} justifyContent={{ sm: "left", md: "center", }} >
                ...
                <Button as="a" colorScheme="gray" display="inline-flex" alignItems="center" justifyContent="center" w={{ base: "full", sm: "auto", }} mb={{ base: 2, sm: 0, }} size="lg" cursor="pointer" > Book a Demo
                    <Icon boxSize={4} ml={1} viewBox="0 0 20 20" fill="currentColor">
