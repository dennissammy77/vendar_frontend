        ...
        <Box bg='#E4F0FC' borderRadius={'md'} boxShadow={'sm'} p='4'>
            <Flex justify={'space-between'}>
                ...
                <HStack align='center' gap='2'>
                    <HStack color='gray.600'  _hover={{color:'#4E2FD7'}} cursor={'pointer'} borderRight={'1px solid'} borderRightColor={'gray.400'} pr='1'>
                        <Text fontSize={'md'} fontWeight={'bold'} >manage</Text>
                        <Icon boxSize='5' as={IoMdSettings} cursor='pointer' onClick={(()=>{router.push(`/dashboard/stores/edit?uid=${user?.data?.data?._id}&&store_id=${store?._id}`)})}/>
                    </HStack>
