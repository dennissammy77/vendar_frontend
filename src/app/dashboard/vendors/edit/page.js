...
function Page() {
    ...
    return (
        <Box>
            <Text fontWeight='bold' fontSize='32px'>Edit Vendor Data</Text>
            <Breadcrumb spacing='8px' separator={<MdChevronRight color='gray.500' />}>
                ...
                <BreadcrumbItem>
                    <BreadcrumbLink href={`/dashboard/vendors/view/?uid=${USER_ID}&account_id=${ACCOUNT_ID}`}>vendor</BreadcrumbLink>
                </BreadcrumbItem>
